...
function manuallyHighlightComponents() {
  ...
  console.log(
    `📋 Found ${components.length} components with data-component-id`,
  );
  ...
  components.forEach((element, index) => {
    ...
    console.log(
      `🎨 Highlighting component ${index + 1}: ${componentId} (${componentCategory})`,
    );
  ...
  console.log(
    `✅ Manual highlighting complete - ${components.length} components highlighted`,
  );
