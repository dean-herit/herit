...
async function testAuthenticatedHighlighting() {
  ...
  console.log(
    `✅ Successfully highlighted ${componentCount} components on beneficiaries page`,
  );
  ...
  const screenshotPath =
    "./tests/screenshots/beneficiaries-highlighted-authenticated.png";
  ...
  await browser.close();
  console.log(
    "🎯 Test complete! Check the screenshot for proof of highlighting on beneficiaries page.",
  );
}
