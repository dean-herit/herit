/**
 * /api/onboarding/legal-consent API Route Test - REAL IMPLEMENTATION
...
import * as routeHandlers from '@/app/api/onboarding/legal-consent/route';
...
describe("/api/onboarding/legal-consent", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe("Core Functionality", () => {
    ...
    it("handles GET requests successfully", async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/onboarding/legal-consent', {
        method: 'GET',
      });
  ...
  describe("Edge Cases", () => {
    ...
    it("handles concurrent requests", async () => {
      ...
      const requests = Array(3).fill(0).map(() => 
        new NextRequest('http://localhost:3000/api/onboarding/legal-consent', { method: 'GET' })
      );
