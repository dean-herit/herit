/**
 * /api/beneficiaries API Route Test - REAL IMPLEMENTATION
...
import * as routeHandlers from '@/app/api/beneficiaries/route';
  ...
  describe("Edge Cases", () => {
    ...
    it("handles concurrent requests", async () => {
      ...
      const requests = Array(3).fill(0).map(() => 
        new NextRequest('http://localhost:3000/api/beneficiaries', { method: 'GET' })
      );
