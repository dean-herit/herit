/**
 * /api/beneficiaries/[id] API Route Test - REAL IMPLEMENTATION
...
describe("/api/beneficiaries/[id]", () => {
  ...
  describe("Core Functionality", () => {
    ...
    it("handles GET requests successfully", async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/beneficiaries/[id]', {
        method: 'GET',
      });
    ...
    it("handles PUT requests successfully", async () => {
      ...
      const response = await routeHandlers.PUT(request, { params: { id: 'test-123' } });
  ...
  describe("Edge Cases", () => {
    ...
    it("handles concurrent requests", async () => {
      ...
      const requests = Array(3).fill(0).map(() => 
        new NextRequest('http://localhost:3000/api/beneficiaries/[id]', { method: 'GET' })
      );
