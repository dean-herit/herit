...
const meta: Meta<typeof RuleConditionsDisplay> = {
  title: "Components/RuleConditionsDisplay",
  component: RuleConditionsDisplay,
  parameters: {
    layout: "centered",
    docs: {
      description: {
        component: "RuleConditionsDisplay component",
      },
    },
  },
