/**
 * Test version of AuthErrorHandler without useRouter dependency
 */
"use client";
...
// Test version that doesn't use useRouter
export function AuthErrorHandlerTest({ error, onRetry }: AuthErrorHandlerProps) {
  const handleForceLogout = async () => {
    try {
      ...
      // Redirect to login with error context - for testing, just use window.location
      window.location.href = `/login?error=auth_${error}`;
    } catch (err) {
