        ...
        <Card>
          <CardBody className="p-6 text-center">
            ...
            <p className="text-sm text-default-600 mb-4">
              This is a simplified verification process for demo purposes. In a
              real application, this would integrate with identity verification
              services.
            </p>
            <Button color="primary" size="lg" onPress={startVerification}>
              Start Verification
            </Button>
          </CardBody>
        </Card>
      ...
      {verificationStatus === "in_progress" && (
        <Card>
          <CardBody className="p-6">
            ...
            <Progress className="mb-4" color="primary" value={progress} />
