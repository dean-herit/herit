...
export const ComponentOverlay = ({ componentId, metadata, children }: ComponentOverlayProps) => {
  ...
  useEffect(() => {
    const checkVisualMode = () => {
      ...
      const localMode = typeof window !== 'undefined' && localStorage.getItem('visualDevMode') === 'true';
