...
import { COMPONENT_REGISTRY, getComponentStats } from '@/lib/component-registry';
...
export const VisualDevModePanel = () => {
  ...
  useEffect(() => {
    ...
    const isActive = process.env.NEXT_PUBLIC_VISUAL_DEV_MODE === 'true' || 
    ...
    const highlightingActive = localStorage.getItem('highlightingEnabled') === 'true' || isActive;
        ...
        <Card className="fixed bottom-20 right-4 z-[10000] w-96">
          <CardBody className="p-4">
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium">Visual Component Mode</span>
                <Switch
                  checked={visualMode}
              ...
              {visualMode && (
                <div className="space-y-3 border-t pt-3">
                  <h4 className="text-sm font-semibold text-gray-700">Highlighting Options</h4>
              ...
              <div className="border-t pt-3 text-xs text-gray-500">
                {visualMode ? (
                  <div className="space-y-1">
                    <div className="font-semibold text-green-600">✅ Visual Mode Active</div>
                  ...
                  <div>
                    💡 Enable visual mode to see component boundaries and metadata
                  </div>
                )}
              </div>
            </div>
